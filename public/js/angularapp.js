...
parentController = ['$scope', '$location', 'fbUrl',
    function ($scope, $location, fbUrl) {
        ...
        $scope.defaultImageData = defaultImageData;
    }
];
